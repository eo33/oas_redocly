import styled,{css}from"styled-components";import{breakpoints}from"@redocly/theme";import{typography}from"../../../utils";import{deprecatedCss}from"../mixins";export const getCssVariable=e=>"undefined"!=typeof document?getComputedStyle(document.documentElement).getPropertyValue(e).trim():"";export const PropertiesTableCaption=styled.caption`
  text-align: right;
  font-size: 0.9em;
  font-weight: normal;
...
`;export const PropertyNameCell=styled(PropertyCell)`
  ...
  ${({kind:e})=>"patternProperties"===e&&css`
      span.field-name {
  ...
  ${()=>{const e=(r="--schema-field-name-word-break","undefined"!=typeof document?getComputedStyle(document.documentElement).getPropertyValue(r).trim():"");var r;if(["break-all","break-word"].includes(e)){const r=`\n      && span:last-child {\n        white-space: normal;\n        word-break: ${e};\n        vertical-align: top;\n        max-width: calc(100% - 21px);\n        display: inline-flex;\n      }\n    `;return css`
