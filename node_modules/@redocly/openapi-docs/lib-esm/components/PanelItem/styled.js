import styled from"styled-components";import{CheckmarkIcon}from"@redocly/theme";export const PanelItemWrap=styled.span`
  display: flex;
...
`;export const Title=styled.span`
  ...
  font-weight: ${({active:t})=>t&&"var(--font-weight-medium)"};
